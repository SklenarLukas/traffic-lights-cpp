...
pedestriansWaitLed::pedestriansWaitLed(gpio_num_t wait_pin, Mode wait_mode)
    : p_wait_pin(wait_pin), p_wait_mode(wait_mode) {
...
pedestriansButton::pedestriansButton(gpio_num_t button_pin)
    : p_button_pin(button_pin) {
